...
assert.strictEqual(Math.round(resModerate.individual.estimatedTime), 711, "TEST 5 FAILED: Individual numerical cost mismatch");
...
assert.strictEqual(Math.round(resModerate.aura.estimatedTime), 750, "TEST 6 FAILED: AURA numerical cost mismatch");
...
assert.strictEqual(Math.round(resExtreme.individual.estimatedTime), 750, "TEST 7 FAILED: Cost mismatch");
